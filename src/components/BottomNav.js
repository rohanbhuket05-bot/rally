...
const NAV_IDS = ['home', 'explore', 'post', 'groups', 'profile'];
const GROUP_TABS = new Set(['groups', 'group', 'group-chat']);

const ICONS = {
  home: (active) => (
    <svg viewBox="0 0 24 24" width="24" height="24" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
